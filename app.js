...
if (settings.heavy != true) {
  bitcoinapi.setAccess('only', ['getinfo', 'getnetworkhashps', 'getmininginfo','getdifficulty', 'getconnectioncount', 
    'getblockcount', 'getblockhash', 'getblock', 'getrawtransaction','listunspent','sendrawtransaction','getinfox']);
} else {
  ...
  */
  bitcoinapi.setAccess('only', ['getinfo', 'getnetworkhashps', 'getdifficulty', 'getconnectioncount', 
    ...
    'getnextrewardwhensec', 'getsupply','listunspent','sendrawtransaction','getinfox']);
}
// view engine setup
